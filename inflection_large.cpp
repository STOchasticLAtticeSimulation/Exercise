...
// ------------ パラメータ ----------------- //
const string filename = "Ncl_inflection_large.dat"; // 出力ファイル名(Ncl)
const string filename_c = "Lattice_inflection_large.dat"; // 出力ファイル名(曲率ゆらぎ)
const string filename_f = "field_inflection_large.dat"; // 出力ファイル名(phi, pi)
...
const int NL = 33; // Number of lattice
