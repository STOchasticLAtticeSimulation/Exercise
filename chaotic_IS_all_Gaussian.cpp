...
// ------------ パラメータ ----------------- //
const string filename = "Ncl_chaotic_biased_g.dat"; // 出力ファイル名(Ncl)
const string filename_c = "Lattice_chaotic_biased_g.dat"; // 出力ファイル名(曲率ゆらぎ)
const string filename_f = "field_chaotic_biased_g.dat"; // 出力ファイル名(phi, pi)
