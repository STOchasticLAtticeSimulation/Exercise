// Inflection model　に importance sampling を実行．全ての omega に対して Normal Distributionを変更．バイアスされたノイズの振幅をGaussianにする.
// g++ -std=c++11 -O2 -o inflection_IS_Gaussian inflection_IS_Gaussian.cpp
// 並列化するなら g++ -std=c++11 -O2 -Xpreprocessor -fopenmp -lomp -o inflection_IS_Gaussian inflection_IS_Gaussian.cpp
// g++ -std=c++11 -O2 -Xpreprocessor -fopenmp -L/opt/homebrew/opt/libomp/lib -lomp -o inflection_IS_Gaussian inflection_IS_Gaussian.cpp
...
const double Nbias = 3; // Biased time
